...
>>> import requests
>>> import bs4
>>> r = requests.get ('https://www.imdb.com/list/ls095396246/?sort=list_order,asc&st_dt=&mode=detail&page=2')
...
movie                 100 non-null object
year                  100 non-null object
genre                 100 non-null object
movie rating          100 non-null object
director and casts    100 non-null object
votes                 100 non-null int64
duration              100 non-null object
gross                 100 non-null object
detail                100 non-null object
dtypes: int64(1), object(8)
memory usage: 7.2+ KB
None
>>> # Export to csv 
movienominee.to_csv('best_picture2_nominee.csv')
>>> 
